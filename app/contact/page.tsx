...
export default function ContactPage() { return <main>
  ...
  <section className="section shell contact-layout"><div className="contact-copy"><p className="section-index">Start a conversation</p><h2>Where can precision take us?</h2><p>Tell us what you&apos;re working on and how you see ARIX fitting into the future of agriculture.</p><div className="contact-topics"><span>Pilot programs</span><span>Investment</span><span>Research</span><span>Talent</span></div></div><ContactForm /></section>
  </main>; }
