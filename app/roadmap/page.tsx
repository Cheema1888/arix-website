...
export default function RoadmapPage() { return <main>
  <section className="page-hero roadmap-hero"><div className="shell"><p className="eyebrow">Build deliberately. Validate in the field.</p><h1>A clear path from<br /><span>insight to action.</span></h1><p>ARIX separates what must be proven now from what becomes possible next.</p></div></section>
