  ...
  return (
    <footer className="site-footer">
      <div className="shell footer-main">
        ...
        <div className="footer-links"><div><span>Explore</span><Link href="/technology">Technology</Link><Link href="/sub-companies">Sub-companies</Link><Link href="/roadmap">Roadmap</Link></div><div><span>Company</span><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/accounts/lock">Accounts login</Link></div><div><span>Follow</span><a href="https://www.linkedin.com/company/arix-solutions/" target="_blank" rel="noreferrer">LinkedIn <i>↗</i></a><a href="https://www.instagram.com/arix.pk?igsh=MTYwY3NiMjluN2Qycw==" target="_blank" rel="noreferrer">Instagram <i>↗</i></a></div></div>
      </div>
