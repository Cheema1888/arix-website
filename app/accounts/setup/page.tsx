  ...
  return (
    <main className="accounts-auth-page accounts-setup-page">
      <section className="accounts-auth-brand">
        ...
        <div><p className="accounts-kicker">First-time setup</p><h1>Create the ARIX finance administrator.</h1><p>This one-time step activates <strong>team@arix.pk</strong> as the first administrator.</p></div>
